      ...
      <div class="card-content">
        <form action="controlador.php" method="post">
          <div class="form-group center-align">
            <label class="black-text text-bold"><h3>Producto: </h3></label>
            <label class="blue-grey-text text-darken-4"><h3><?php echo $_REQUEST['prop'] ?> </h3></label>
          </div>
          <input type="hidden" name="txtidEliminaP" value="<?php echo $_REQUEST['idR'] ?>">
          <div class="container center">
            <button type="submit" name="btnEliminaP" class="btn deep-orange darken-3 ">Si, Eliminar </button>
            <button type="submit" name="btnRegresoP" class="btn green lighten-2">No, Regresar </button>
          </div>
        </form>
      </div>
    </div>
