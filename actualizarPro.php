...
<div class="container" class="row">
    ...
    <div class="card teal lighten-5">
      <div class="card-content">
        <h4 class="card-title center-align">Actuzalizar Producto</h4>
        <form action="controlador.php"  method="POST" onsubmit="return vaciosProducto();">
        <div class="row">
            <div class="input-field col s12">
              <i class="material-icons prefix">edit</i>
              <input type="text" id="txtnombrep" name="txtnombrep" class="validate" value="<?php echo $_REQUEST['prop'];?>"/>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="text" id="txtdes" name="txtdes" class="validate" value="<?php echo $_REQUEST['prod'];?>"/>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="number" id="txtcant" name="txtcant" class="validate" value="<?php echo $_REQUEST['proc'];?>"/>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="number" placeholder="0.0" step="any" id="txtprecioa" name="txtprecioa" value="<?php echo $_REQUEST['propa'];?>"class="validate" />
              <label for="email">Precio de Adquisición</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <i class="material-icons prefix">monetization_on</i>
              <input type="number" placeholder="0.0" step="any" id="txtpreciov" name="txtpreciov" class="validate" value="<?php echo $_REQUEST['propv'];?>"/>
          ...
          <div class="row center-align">
            ...
            <button type="submit" name="btnAproducto" class="btn waves-effect waves-light col s12">Actualizar Producto</button>
            </div>
          </div>
        </form>
      </div>
