  ...
  <div class="col s12 l4 offset-l4">
    <div class="card teal lighten-5">
      <div class="card-content">
        <h4 class="card-title center-align">Registrar Usuario</h4>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="email" id="txtcorreo" name="txtcorreo" class="validate" />
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="password" id="txtpass" name="txtpass" class="validate" />
          ...
          <div class="input-field col s12">
          <button type="submit" name="btnGusuario" class="btn waves-effect waves-light col s12">Guardar Usuario</button>
          </div>
            </button>
          </div>
        </form>
