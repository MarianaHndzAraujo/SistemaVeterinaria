...
<div class="navbar-fixed">
  ...
  <li><a href="buscarProducto.php">Buscar</a></li>
    ...
    <div class="col s12 m7">
      <h1 class="header" style="text-align: center">Consulta Usuarios</h1>
      <div class="card">
              ...
              <?php
                ...
                while ($arrUsu=mysqli_fetch_array($rsUsu)) {
                  echo"<tr>
                      ...
                      <td>".$arrUsu['pass']."</td>
                      <td>".$arrUsu['perfil']."</td>
                      <td><a href='actualizarUsu.php?idR=".$arrUsu['idUsuario']."&usuNombre=".$arrUsu['nombre']."&usuR=".$arrUsu['usuario']."&usuPass=".$arrUsu['pass']."&usuPer=".$arrUsu['perfil']."'><img src=images/upload.png></a></td>
                      <td><a href='confirmarEliUsu.php?idR=".$arrUsu['idUsuario']."&usuR=".$arrUsu['usuario']."'><img src=images/borrar.png></a></td>
                       </tr>";
                }
              ?>
            </tbody>
